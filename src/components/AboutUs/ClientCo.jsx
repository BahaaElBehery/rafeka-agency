    ...
    <div className="w-11/12 mx-auto grid grid-cols-2 max-lg:grid-cols-1 gap-10 mt-20">
      <div className="flex flex-col max-lg:items-center max-lg:order-2">
        <div className="flex items-center max-lg:hidden">
          ...
          <h3 className="ml-3">{Props.one}</h3>
        </div>
        ...
        <div className={Props.hide}>
          <ClientPart
            ...
            per="98%"
            className="absolute top-0 left-0 h-full w-[98%] bg-red-500 rounded-full"
          />
          <ClientPart
            title="Project Completion Rate"
            per="95%"
            className="absolute top-0 left-0 h-full w-[95%] bg-red-500 rounded-full"
          />
          <ClientPart
            title="Campaign Success Rate"
            per="90%"
            className="absolute top-0 left-0 h-full w-[90%] bg-red-500 rounded-full"
          />
        </div>
      </div>
